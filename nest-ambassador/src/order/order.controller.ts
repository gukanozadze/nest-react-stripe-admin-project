...
export class OrderController {
    ...
    async create(@Body() body: CreateOrderDto) {
        ...
        try {
            ...
            const source = await this.stripeClient.checkout.sessions.create({
                ...
                line_items,
                success_url: `${this.configService.get('CHECKOUT_UR')}/success?source={CHECKOUT_SESSION_ID}`,
                cancel_url: `${this.configService.get('CHECKOUT_UR')}/error`,
            })
    ...
    async confirm(@Body('source') source: string) {
        ...
        // Updating order to save it as complete
